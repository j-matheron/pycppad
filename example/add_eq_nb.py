...
from pycppad import AD, Independent, ADFun, Value, ADVector
...
y = ADVector()
y.append(x[0])
print("y.append(x[0]) --> Value(y[0]):", Value(y[0]), type(y[0]), " y type : ", type(y))
print("y[0]: ", y[0])

# initial value
y[0] += AD(2)
print("y[0] += AD(2) --> Value(y[0]):", Value(y[0]), type(y[0]))


# AD<double> += int
y[0] += AD(4.0)
print("y[0] += AD(4.0) --> Value(y[0]):", (Value(y[0]), type(y[0])))

# AD<double> += double
y[0] += x[0]
print("y[0] += x[0] --> (y[0]):", (y[0]), type(y[0]))

y.append(y[0])
print(" Value(y[1]):", Value(y[1]), type(y[0]))
print("expected value for y[0]:", x0 + 2.0 + 4.0 + x0)
